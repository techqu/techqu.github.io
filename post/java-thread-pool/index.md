...
`java.util.concurrent.ThreadPoolExecutor`类是线程池中最核心的一个类，因此如果要透彻地了解Java中的线程池，必须先了解这个类。
...
{{% admonition type="quote" title="举个例子" details="false" %}}
...
{{% admonition type="note" title="新提交一个任务时的处理流程很明显：" details="false" %}}
